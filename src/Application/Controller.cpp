...
int Controller::test(int test, int quantifier)
{
	...
	if (doSTAR)
	{
		//*********** STAR BF Tests ***********//
		//conf = {"STAR", "SIFT", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "SIFT";
		conf[0]->matcher = "BF";
		//conf = {"STAR", "BRIEF", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "BRIEF";
		conf[0]->matcher = "BF";		
		//conf = {"STAR", "ORB", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "ORB";
		conf[0]->matcher = "BF";
		//conf = {"STAR", "SURF", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "SURF";
		conf[0]->matcher = "BF";
		//conf = {"STAR", "BRISK", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "BRISK";
		conf[0]->matcher = "BF";
		//conf = {"STAR", "FREAK", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "FREAK";
		conf[0]->matcher = "BF";
		//conf = {"STAR", "AKAZE", "BF"};
		conf[0]->detector = "STAR";
		conf[0]->extractor = "AKAZE";
		conf[0]->matcher = "BF";
